...
Insert into EMP (EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,DEPTNO) values (8008,'BIPLAB  ','CRELK',7788,STR_TO_DATE('12-07-89','%d-%m-%y'),8999,20);
...
Insert into EMP (EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,DEPTNO) values (8011,'KINE','CLERK',7788,STR_TO_DATE('16-09-22','%d-%m-%y'),9800,30);
...
CATEGORY VARCHAR(200),
 ...
 Insert into BOOKS (BOOKID,BOOKNAME,CATEGORY,AUTHOR,PUBLICATIONDATE,LANGUAGE,DESCRIPTION) values (1001,'In Search Of Her','Fiction','Deesha Sangani',STR_TO_DATE('12-08-20','%d-%m-%y'),'English','A mother who would stop at nothing for her child, is a dangerous woman to mess with.');
 
Insert into BOOKS (BOOKID,BOOKNAME,CATEGORY,AUTHOR,PUBLICATIONDATE,LANGUAGE,DESCRIPTION) values (1002,'You are the best wife','Fiction','Ajaya Pandey',STR_TO_DATE('23-11-15','%d-%m-%y'),'English','You Are The Best Wife: A True Love Story is a story about how people find true love and comfort in dissimilarities; about how two people with absolutely different ideologies meet and fall in love');
 
Insert into BOOKS (BOOKID,BOOKNAME,CATEGORY,AUTHOR,PUBLICATIONDATE,LANGUAGE,DESCRIPTION) values (1003,'Something I Never Told You','Adventure','Shravya Bhinder',STR_TO_DATE('02-05-19','%d-%m-%y'),'English',null);
 
Insert into BOOKS (BOOKID,BOOKNAME,CATEGORY,AUTHOR,PUBLICATIONDATE,LANGUAGE,DESCRIPTION) values (1004,'Chanakya Neeti','Literature','Ashwini Parashar',STR_TO_DATE('01-08-22','%d-%m-%y'),'Hindi','सिकंदर ने पंजाब, गांधर आदि राज्यों को जीतकर उन्हें अपने अधीन कर लिया था। वहां यवन सैनिकों के अत्याचारों से लोग त्रास्त थे। चारों तरफ आतंक व्याप्त था। बहू-बेटियों की अस्मिता असुरक्षित थी। यवन पूरे भारत को जीतना चाहते थे। स्थिति बड़ी दयनीय थी। यवनों के राज्य का विस्तार पूरे भारतवर्ष में हो, यह चाणक्य जैसे आत्मसम्मानी देशभक्त के लिए असहनीय थ');
...
INSERT INTO LIBRARY (TRANID, EMPID, BOOKID, ISSUEDATE, RETURNDATE) 
VALUES (100001, 8010, 1001, '2022-03-02 00:00:00', '2022-03-15 00:00:00');

INSERT INTO LIBRARY (TRANID, EMPID, BOOKID, ISSUEDATE, RETURNDATE) 
VALUES (100003, 8010, 1002, '2022-09-19 00:00:00', '2022-09-22 00:00:00');

INSERT INTO LIBRARY (TRANID, EMPID, BOOKID, ISSUEDATE, RETURNDATE) 
VALUES (100004, 8006, 1001, '2022-01-19 00:00:00', '2022-02-22 00:00:00');

INSERT INTO LIBRARY (TRANID, EMPID, BOOKID, ISSUEDATE, RETURNDATE) 
VALUES (100005, 8006, 1002, '2022-05-12 00:00:00', '2022-05-12 00:00:00');

INSERT INTO LIBRARY (TRANID, EMPID, BOOKID, ISSUEDATE, RETURNDATE) 
VALUES (100006, 8006, 1003, '2022-07-08 00:00:00', '2022-08-09 00:00:00');

INSERT INTO LIBRARY (TRANID, EMPID, BOOKID, ISSUEDATE, RETURNDATE) 
VALUES (100007, 8006, 1004, '2022-04-19 00:00:00', '2022-09-22 00:00:00');

INSERT INTO LIBRARY (TRANID, EMPID, BOOKID, ISSUEDATE, RETURNDATE) 
VALUES (100008, 8001, 1001, '2022-02-19 00:00:00', NULL);

INSERT INTO LIBRARY (TRANID, EMPID, BOOKID, ISSUEDATE, RETURNDATE) 
VALUES (100009, 8001, 1002, '2022-09-12 00:00:00', NULL);

INSERT INTO LIBRARY (TRANID, EMPID, BOOKID, ISSUEDATE, RETURNDATE) 
VALUES (100010, 8001, 1003, '2022-09-08 00:00:00', NULL);

INSERT INTO LIBRARY (TRANID, EMPID, BOOKID, ISSUEDATE, RETURNDATE) 
VALUES (100002, 8010, 1001, '2022-09-19 00:00:00', NULL);
